...
def loadDataSet():
    ...
    potus = list(reader(open('EpiData6.csv', encoding='UTF-8')))
    print(potus)
    # dataSet3 = [line.split() for line in open("EpiData6.dat", encoding='UTF-8').readlines()]
    # print(dataSet3)
    list2 = [[1, 3, 4], [2, 3, 5], [1, 2, 3, 5], [2, 5], [2, 3, 5], [1, 2, 3, 5], [2, 5]]
    # print(list2)
    # return dataSet3++++++++++++++
    return potus
