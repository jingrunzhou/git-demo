...
class apriori():
    ...
    def runApriori(self,data_iter, minSupport, minConfidence,minLift = 0.1,tuples =3,count = 100000):
        """
...
if __name__ == "__main__":
    ...
    # ------------ 2 先编译再导入  ------------
    data = pd.read_csv('EpiData4.csv',header = None)
    ...
    minConfidence = 0.0
    minLift = 0.0
    items, rules = apr.runApriori(inFile, minSupport, minConfidence,minLift,tuples = 3,count = 185)
