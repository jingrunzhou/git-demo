...
# 加载数据集
def loadDataSet():
    return [[1, 3, 4], [2, 3, 5], [1, 2, 3, 5], [2, 5],[1, 3, 4],[1, 3, 4],[1, 3, 4],[1, 3, 4],[1, 3, 4],[1, 3, 4],[6,77,88]]
...
def main():
    ...
    dataSet = [line.split() for line in open("C:/Users/Zhou/Desktop/AiLearning-master/ata/11.Apriori/mushroom.dat").readlines()]
    L, supportData = apriori(dataSet, minSupport=0.3)
    # # 2表示毒蘑菇，1表示可食用的蘑菇
